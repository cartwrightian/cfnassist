...
Also note the tool automaticalls injects the correct VPC and env (i.e. dev, UAT, Prod, etc).
...
cnfassit auto-populated some parameters when it invokes the cloud formation api, 
